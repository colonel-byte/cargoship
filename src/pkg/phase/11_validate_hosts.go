...
// ReadOnly marks this phase safe under a dry run. ValidateHosts is the preflight itself: sudo,
// unique hostnames and addresses, host architecture, firewall rules and clock skew. A dry run
// that skipped it would check nothing.
func (p *ValidateHosts) ReadOnly() {}
