...
// ReadOnly marks this phase safe under a dry run. DetectOS reads /etc/os-release and the
// kernel to pick a Configurer. Reporting what each host runs is half of what makes a dry run
// worth running.
func (p *DetectOS) ReadOnly() {}
