...
// ReadOnly marks this phase safe under a dry run. GatherFacts asks each host its hostname,
// private interface and private address. All three are reads, and the rest of the walk decides
// what it would do from them.
func (p *GatherFacts) ReadOnly() {}
