...
// Code generated by mage generate:engineConfig from rke2 v1_37 (server). DO NOT EDIT.
...
// ServerConfig is the server config.yaml key set for rke2 v1_37.
type ServerConfig struct {
	...
	WriteKubeconfigName           string   `yaml:"write-kubeconfig-name,omitempty"`
