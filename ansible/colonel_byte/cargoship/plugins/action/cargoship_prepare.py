...
"""Action plugin for the cargoship_prepare module.
...
short_description: Stage a package onto the fleet and ready the hosts
description:
  - "Runs C(cargoship prepare) against the fleet described by an Ansible inventory."
