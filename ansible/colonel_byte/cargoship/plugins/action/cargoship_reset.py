...
"""Action plugin for the cargoship_reset module.
...
short_description: Remove the cluster from the fleet
description:
  - "Runs C(cargoship reset) against the fleet described by an Ansible inventory."
